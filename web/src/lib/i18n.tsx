...
const vi = {
  ...
  userIdLabel: 'User ID (cuid)', roleLabel: 'Vai trò', memberLabelField: 'Tên hiển thị trong task',
...
const en: typeof vi = {
  ...
  userIdLabel: 'User ID (cuid)', roleLabel: 'Role', memberLabelField: 'Task display label',
